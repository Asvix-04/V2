                            ...
                            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                                ...
                                <div className="flex items-center justify-end px-2 py-2">
                                    ...
                                    <button
                                        ...
                                        className="h-8 px-2 text-zinc-400 hover:text-red-500 flex items-center justify-center transition-colors"
                                    ...
                                    {sessions.length > 0 ? (
                                        ...
                                        sessions.map((session) => (
                                            ...
                                            >
                                                ...
                                                <MessageSquare className={cn("h-4 w-4", currentSessionId === session.id ? "text-blue-600 dark:text-blue-400" : "text-zinc-400")} />
