                    ...
                    <form onSubmit={handlePasswordLogin} className="space-y-4">
                        ...
                        <div className="flex justify-end mt-1">
                            <button
                                ...
                                onClick={handleSelectOtp}
                                disabled={loading}
                                className="text-xs text-accent hover:text-accent-bright font-medium transition-colors disabled:opacity-50"
                            >
                                Forgot password?
                            </button>
                        </div>
                        <Button className="w-full mt-2" size="lg" disabled={loading} isLoading={loading}>
                            Sign In
                        </Button>
                        <button
                            type="button"
