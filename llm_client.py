...
AVAILABLE_MODELS = {
    "1": ModelConfig(
        ...
        api="gemini",
        description="[Speed] Gemini 2.5 Flash Lite — Default (Fast, cost-efficient)",
    ...
    "4": ModelConfig(
        ...
        api="claude",
        description="[Speed] Claude 3.5 Haiku — Anthropic's fastest & cheapest model",
        default_max_tokens=2500,
    ),
    "5": ModelConfig(
        ...
        api="deepseek",
        description="[Speed] DeepSeek V4 Flash — Fastest V4, 1M context",
        default_max_tokens=3000,
    ),
    "6": ModelConfig(
        id="deepseek-v4-pro",
            ...
            try:
                ...
                if "429" in error_str or "RESOURCE_EXHAUSTED" in error_str:
                    ...
                    if "perday" in err_lower or "daily" in err_lower or "limit: 20" in err_lower:
                        print("[Warning] Daily Gemini API quota exceeded. Skipping retries.")
                        return None
