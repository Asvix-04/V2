...
class EnhancedHybridRetriever:
    ...
    def __init__(self, pinecone_index: str = "pdf-knowledge-base",
                 bm25_cache_path: str = "data/bm25_corpus.json"):
        # bm25_cache_path is passed through so each model can be bound to the BM25
        # corpus that matches its own Pinecone index (see llm_client.ModelConfig and
        # PDFChatbot._get_retriever). Without it every index would share the default
        # corpus and DigiLab Pro / v2 keyword search would read the wrong cache.
