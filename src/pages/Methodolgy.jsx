...
export function Methodology() {
  return (
    <PageTransition className="flex min-h-screen flex-col bg-gradient-to-b from-background-base via-background-base to-background-base text-foreground">
      {/* HERO HEADER */}
      <header className="relative border-b border-white/5 pt-20 pb-20 text-center">
      ...
      {/* FOOTER */}
      <footer className="border-t border-white/5 bg-background-base/50 backdrop-blur-sm py-8 text-center text-sm text-foreground-muted">
        <p>© {new Date().getFullYear()} DigiLab Academic AI. All rights reserved.</p>
      </footer>
    </PageTransition>
  );
}
