...
import { User, LogOut, CreditCard, MapPin, Globe, Smile, Bell, Shield, Settings, ChevronDown, Lock, Smartphone, Laptop, Check, Mail, Eye, EyeOff, Download, Trash2, AlertTriangle, Palette, Moon, Sun, Zap, FileText, FileJson, MessageSquare } from "lucide-react";
...
export function ProfilePage() {
        ...
        try {
            ...
            setFormData({
                ...
                preferences: {
                    ...
                    disappearingMessagesEnabled: data.preferences?.disappearingMessagesEnabled || false
                }
            });
    ...
    const toggleChatPreference = (key) => {
        setFormData(prev => ({
            ...prev,
            preferences: {
                ...prev.preferences,
                        ...
                        <Card className="p-8 space-y-10">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-2 border-b border-white/5 pb-2">
                                    ...
                                    <h3 className="text-xl font-medium text-foreground">Chat Settings</h3>
                                </div>
                                <div className="space-y-2">
                                    <Toggle
                                        enabled={formData.preferences?.disappearingMessagesEnabled || false}
                                        onChange={() => toggleChatPreference('disappearingMessagesEnabled')}
                                        title="Disappearing Messages"
                                        description="Messages will automatically be deleted after 24 hours if enabled"
                                    />
                                </div>
                            </div>
