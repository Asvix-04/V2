...
function ContributorCard({ person }) {
  return (
    <div className="group rounded-2xl border border-black/10 dark:border-white/10 bg-white dark:bg-white/5 p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="flex justify-center gap-3 pt-2 flex-wrap">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm bg-accent/10 text-accent hover:bg-accent/20 transition-colors"
        >
        ...
        <a
          ...
          className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm border border-black/10 dark:border-white/10 hover:bg-white/10 transition-colors"
        >
